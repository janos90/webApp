...
function processForm(form) {
  try {
    ...
    styles+="form { width:850px; }  .flex {display: flex;} .bold {font-weight: bold;} .plate {font-weight: normal;}"
    ...
    styles+="#prenail-selection-body { display: flex; flex-wrap: wrap; }"
    styles+="#prenail-selection-body label { flex-grow: 1; }"
    styles+="</style>"
    headEnd+="</head>"
    ...
    clientDetails+= "<label >Site Address<div style='border:black solid 1px;'>"+form['job-info-address']+"</div></label>"
    ...
    clientDetails+= "<label >Notes<div style='border:black solid 1px;'>"+form['job-info-notes']+"</div></label>"
    ...
    outsourcingSelection+="<ul class='outsourcing-selection-ul miscellaneous'>  <header>Miscellaneous</header>"
    outsourcingSelection+="<li class='outsourcing-selection-li'><label for='outsourcing-selection-miscellaneous-email'>Extra Outsourcing Email"
    outsourcingSelection+="<input class='text' type='text' value='"+form['outsourcing-selection-miscellaneous-email']+"' /></label></li>"
    outsourcingSelection+="</ul>"
    ...
    estimationContent+= "<div class='toggle-section timber-floor'><header id='toggle-section-header-timber-floor' class='toggle-section-header'>Timber Floor & Mid Floor"
    ...
    estimationContent+="Prenailer Supplied - Do not allow</label>"
    estimationContent+="<label class='wall-framing random'for='wall-framing-random'><input class='checkbox' type='checkbox' "+(form['wall-framing-random']?'checked':'')+" />50lm Random</label>"
    ...
    estimationContent+=   " <label class='flex bold'>      Frame Treatment"
    ...
    prenailContentSubmitted+= "<div class='checkboxContainer'><h3>Prenail</h3>"
    prenailContentSubmitted+= "<label class='prenail-q-label'><input class='checkbox' type='checkbox' "+(form['prenailFramesCheck']?'checked':'')+"  />"
    prenailContentSubmitted+= "Prenail Wall Frames<input type='text' value='"+(form['prenailFramesText'])+"' class='single-input' /></label>"
    prenailContentSubmitted+= "<label class='prenail-q-label'><input class='checkbox' type='checkbox' "+(form['prenailTrussesCheck']?'checked':'')+"  />"
    prenailContentSubmitted+= "Trusses<input type='text' value='"+(form['prenailTrussesText'])+"' class='single-input' /></label>"
    prenailContentSubmitted+= "<label class='prenail-q-label'><input class='checkbox' type='checkbox' "+(form['prenailPrecutRaftersCheck']?'checked':'')+"  />"
    ...
    generalOutsourcingBody += jobNumber+"&body=Just%20letting%20you%20know%20we%20received%20the%20job'>link</a>"
    ...
    generalOutsourcingBody += "<br>All pricing, queries and RFI to go to estimations@hillsideitm.co.nz"
