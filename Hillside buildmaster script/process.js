...
estimationContent+= "<input type='checkbox'  id='as-plan-timber-floor' name='as-plan-timber-floor'/></label>"
...
estimationContent+= "<input type='checkbox' id='toggle-as-selected-timber-floor' name='toggle-as-selected-timber-floor'/></label>"
...
estimationContent+= "<input type='checkbox' id='toggle-none-timber-floor' name='toggle-none-timber-floor'/></label>"
estimationContent+= "</header>"
estimationContent+= "<main class='toggle-section-questions' id='toggle-section-questions-timber-floor'>"
estimationContent+= "<label class='timber-floor bearers'for='timber-floor-bearers'><input class='checkbox' type='checkbox' name='timber-floor-bearers-check' />"
estimationContent+= "Bearers<input class='single-input' type='text' name='timber-floor-bearers-text' /></label>"
estimationContent+= "<label class='timber-floor Joists'for='timber-floor-Joists'><input class='checkbox' type='checkbox' name='timber-floor-Joists-check' />"
estimationContent+= "Joists<input class='single-input' type='text' name='timber-floor-Joists-text' /></label>"
estimationContent+= "<label class='timber-floor flooring'for='timber-floor-flooring'><input class='checkbox' type='checkbox' name='timber-floor-flooring-check' />"
estimationContent+= "Flooring<input class='single-input' type='text' name='timber-floor-flooring-text' /></label>"
estimationContent+= "<label class='timber-floor wet-area-flooring'for='timber-floor-wet-area-flooring'><input class='checkbox' type='checkbox' name='timber-floor-wet-area-flooring-check' />"
estimationContent+= "Wet Area Flooring<input class='single-input' type='text' name='timber-floor-wet-area-flooring-text' /></label>"
estimationContent+= "<label class='timber-floor tile-slate-underlay'for='timber-floor-tile-slate-underlay'><input class='checkbox' type='checkbox' name='timber-floor-tile-slate-underlay-check' />"
estimationContent+= "Tile & Slate Underlay<input class='single-input' type='text' name='timber-floor-tile-slate-underlay-text' /></label>"
