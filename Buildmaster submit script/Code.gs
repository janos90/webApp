...
function processForm(form) {
  try {
    ...
    content += "<form id='myForm' align='center' onsubmit='handleFormSubmit(this)'>"
        ...
        content += "<div class='main'>"
          ...
          content += "<div class='pair'>"
            ...
            content += "<div class='checkboxContainer'> <header>Job</header> "
              ...
              content += "<input class='textbox' value='" + form.jobPrenail + "' style='width: 91%' type='text' placeholder='Requested return date if less than standard'>  "
      ...
      content += "<div class='pair'>"
        content += "<div class='checkboxContainer'>"
          content += "<p class='row'><select class='specplanselect' name='variable39' required value=" + form.variable39 + ">"
          content += "<option disabled selected value=''>" + form.variable39 + "</option></select>Dimensioned floor plan</p>"
          content += "<p class='row'><select class='specplanselect' name='variable40' required value=" + form.variable40 + ">"
          content += "<option disabled selected value=''>" + form.variable40 + "</option></select>Elevations</p>"
          content += "<p class='row'><select class='specplanselect' name='variable41' required value=" + form.variable41 + ">"
          content += "<option disabled selected value=''>" + form.variable41 + "</option></select>Cross-Section</p>"
        content += "</div>"
        content += "<div class='checkboxContainer'>"
          content += "<p class='row'><select class='specplanselect' name='variable42' required value=" + form.variable42 + ">"
          content += "<option disabled selected value=''>" + form.variable42 + "</option></select>Roof plan confirming pitch</p>"
          content += "<p class='row'><select class='specplanselect' name='variable44' required value=" + form.variable44 + ">"
          content += "<option disabled selected value=''>" + form.variable44 + "</option></select>Rafters design and sizing</p>"
        content += "</div>"
