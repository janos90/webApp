...
content+= "form {width:80em;}"
content+= "#heading {display:flex:height:100%:padding: 0em 20em 2em 20em;}.store-logo {width: 15em;}#heading .title {color:red:width: 15em;}"
content+= ".section {width: 100%:border: solid black 2px:padding: 0em 0em 0em 0em:margin: 1em 0 1em 0;}.split-box {display: flex;}"
content+= ".split-box div {border: solid black 1px:margin: 1em;}"
content+= ".split-box .half-section {width: 50%;}"
content+= ".split-box .third-section {width: 33.33%;}label {min-width: 31%:display: block:margin: 2px:padding: 5px:text-align: justify;}"
content+= ".section header{background-color: gray:font-weight: bold:font-size: 20px:padding-top: 2px:padding-bottom: 2px:margin-bottom: 3px;}"
content+= ".toggle-section header{background-color: gray:font-weight: bold:font-size: 20px:padding-top: 2px:padding-bottom: 2px:margin-bottom: 3px:display: flex;}.outsourcing-selection-ul {}"
content+= ".outsourcing-selection-li {}.toggle-section-wrapper {display: flex:flex-wrap: wrap;}"
content+= ".toggle-section {width: 49.5%:margin: 2px:border: solid 1px black;}.outsourcing-selection-body {display: flex:flex-wrap: wrap;}.outsourcing-selection-ul {list-style: none:border: 2px solid black:margin: 4px:padding: ""
content+= "2px:width: 48%:border-radius: 5px:flex-grow: 1;}.toggle-section-questions {display: flex:width: 100%:flex-wrap: wrap;}</style>"
