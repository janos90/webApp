...
function processForm(form) {
  try {
    ...
    clientDetails+= "<input type='checkbox' "+form['tickbox-preliminary-plan']+" ></label>    <label for='tickbox-preliminary-plan'>"
    clientDetails+= "Consented plan"
    clientDetails+= "<input type='checkbox' "+form['tickbox-preliminary-plan']+" ></label>    <label for='quote-info-plan-version'>"
    ...
    outsourcingSelection+= "<input class='checkbox' type='checkbox' "+form['outsourcing-selection-outsourcing-insualtion-adl-insulation']+"  /></label></li>"
    ...
    outsourcingSelection+= "<input class='checkbox' type='checkbox' "+form['outsourcing-selection-structural-steel-allwin']+"  /></label></li>"
    ...
    outsourcingSelection+= "<input class='checkbox' type='checkbox' "+form['outsourcing-selection-cladding-rosenfield']+" /></label></li>"
    outsourcingSelection+= "<li class='outsourcing-selection-li'><label for='outsourcing-selection-cladding-abodo'>Abodo"
    outsourcingSelection+= "<input class='checkbox' type='checkbox' "+form['outsourcing-selection-cladding-abodo']+"  /></label></li>"
    outsourcingSelection+= "<li class='outsourcing-selection-li'><label for='outsourcing-selection-cladding-jsc'>JSC"
    outsourcingSelection+= "<input class='checkbox' type='checkbox' "+form['outsourcing-selection-cladding-jsc']+"  /></label></li></ul>"
    ...
    outsourcingSelection+= "<input class='checkbox' type='checkbox' "+form['outsourcing-selection-roofing-new-era-sfi']+" /></label></li>"
    outsourcingSelection+= "<li class='outsourcing-selection-li'>"
    outsourcingSelection+= "<label for='outsourcing-selection-roofing-johnson-roofing-sfi'>Johnson Roofing SFI"
    outsourcingSelection+= "<input class='checkbox' type='checkbox' "+form['outsourcing-selection-roofing-johnson-roofing-sfi']+"  /></label></li>"
    outsourcingSelection+= "<li class='outsourcing-selection-li'>"
    ...
    outsourcingSelection+= "<input class='checkbox' type='checkbox' "+form['outsourcing-selection-roofing-roofing-industries-material-only']+" /></label></li></ul></main></div>"
