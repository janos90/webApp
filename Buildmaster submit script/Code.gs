...
function processForm(form) {
  try {
    ...
    content += "<p>Frame/Trusses <span style='color: red'>MARGIN</span>: <input class='textbox right' value='" + form.officeFrames   + "' type='text' placeholder='Frame/truss margin' style='width: 45%;'></p>"
    ...
    content += "<p>Reason: <input class='textbox right' value='" + form.officeReason   + "' type='text' placeholder='Reason' style='width: 45%;'></p>  </div></div>  </div>"
