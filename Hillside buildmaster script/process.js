...
estimationContent += (form['cancel-estimation']?'not Required':'Tick sections or Items') +"</header>"
 ...
 estimationContent +="<input type='checkbox' id='toggle-none-foundations' "+(form['toggle-none-foundations']?'checked':'')+" /></label>"
  ...
  estimationContent +="<main "+(form['toggle-as-selected-foundations']?"style='display:block;'":"style='display:none;'")+"  class='toggle-section-questions' id='toggle-section-questions-foundations'>"
  ...
  estimationContent+= "<main "+(form['toggle-as-selected-timber-floor']?"style='display:block;'":"style='display:none;'")+" class='toggle-section-questions' id='toggle-section-questions-timber-floor'>"
  ...
  estimationContent+= "</main></div>"
        ...
        estimationContent+="<main "+(form['toggle-as-selected-wall-framing']?"style='display:block;'":"style='display:none;'")+" class='toggle-section-questions' id='toggle-section-questions-wall-framing' >"
        ...
        estimationContent+="<main "+(form['toggle-as-selected-roof-framing']?"style='display:block;'":"style='display:none;'")+" class='toggle-section-questions' id='toggle-section-questions-roof-framing'>"
        ...
        estimationContent+="<main "+(form['toggle-as-selected-exterior-finishing']?"style='display:block;'":"style='display:none;'")+" class='toggle-section-questions' id='toggle-section-questions-exterior-finishing'>"
        ...
        estimationContent+="<main "+(form['toggle-as-selected-cladding']?"style='display:block;'":"style='display:none;'")+" class='toggle-section-questions' id='toggle-section-questions-cladding'><label class='cladding brick'for='cladding-brick'>"
        ...
        estimationContent+="<main "+(form['toggle-as-selected-insulation']?"style='display:block;'":"style='display:none;'")+" class='toggle-section-questions' id='toggle-section-questions-insulation'>"
        ...
        estimationContent+="<main "+(form['toggle-as-selected-interior-linings']?"style='display:block;'":"style='display:none;'")+" class='toggle-section-questions' id='toggle-section-questions-interior-linings'>"
        ...
        estimationContent+="<main "+(form['toggle-as-selected-interior-doors']?"style='display:block;'":"style='display:none;'")+" class='toggle-section-questions' id='toggle-section-questions-interior-doors'>"
        ...
        estimationContent+="<main "+(form['toggle-as-selected-interior-finishings']?"style='display:block;'":"style='display:none;'")+" class='toggle-section-questions' id='toggle-section-questions-interior-finishings'>"
        ...
        estimationContent+="<main "+(form['toggle-as-selected-landscaping']?"style='display:block;'":"style='display:none;'")+" class='toggle-section-questions' id='toggle-section-questions-landscaping'>"
