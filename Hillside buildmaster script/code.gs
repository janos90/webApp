...
function processForm(form) {
  try {
    ...
    clientDetails+= "Phone Number"
    clientDetails+= "<input class='single-input' type='text' value="+form['customer-info-phone']+"  /></label>    </div>"
    clientDetails+= "<div class='half-section' id='job-info'>"
    clientDetails+= "<header>"
    clientDetails+= "Job Information"
    clientDetails+= "</header>"
    clientDetails+= "<label for='job-info-address'>"
    clientDetails+= "Site Address"
    clientDetails+= "<input class='textbox-input' type='text' value="+form['job-info-address']+"  /></label>    </div>"
    clientDetails+= "</div>"
    ...
    content+= "<li class='outsourcing-selection-li'><label for='outsourcing-selection-prenail-ntml'>"
    content+= "NTML"
    ...
    content+= "</li>"
    content+= "</ul>"
    content+= "<ul class='outsourcing-selection-ul reinforcing'><header>Reinforcing</header>"
    content+= "<li class='outsourcing-selection-li'>"
    ...
    content+= "<li class='outsourcing-selection-li'>"
    content+= "<label for='outsourcing-selection-ribraft-rfl'>RFL"
    ...
    content+= "<li class='outsourcing-selection-li'>"
    content+= "<label for='outsourcing-selection-doors-internal-elite'>Elite"
    content+= "<input class='checkbox' type='checkbox' value="+form['outsourcing-selection-doors-internal-elite']+"  /></label></li>"
    content+= "<li class='outsourcing-selection-li'>"
    content+= "<label for='outsourcing-selection-doors-internal-nationwide'>Nationwide"
