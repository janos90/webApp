...
function processForm(form) {
  try {
    ...
    clientDetails+= "<input type='checkbox' "+(form['tickbox-preliminary-plan']?'checked':'')+" ></label>    <label for='tickbox-preliminary-plan'>"
    clientDetails+= "Consented plan"
    clientDetails+= "<input type='checkbox' "+(form['tickbox-preliminary-plan']?'checked':'')+" ></label>    <label for='quote-info-plan-version'>"
    ...
    clientDetails+= "<input class='single-input' type='text' value="+form['customer-info-name']+" /></label><label for='customer-info-email'>"
    ...
    outsourcingSelection+= "Outsourcing not Required <input type='checkbox' class='checkbox' id='cancel-outsourcing' value="+form['cancel-outsourcing']+" onclick='toggleOutsourcing()'/>    </header>"
    ...
    outsourcingSelection+= "<input class='checkbox' type='checkbox' "+(form['outsourcing-selection-prenail-ntml']?'checked':'')+"  /></label>  </li>"
    outsourcingSelection+= "<li class='outsourcing-selection-li'><label for='outsourcing-selection-prenail-dayles'>Dayles"
    outsourcingSelection+= "<input class='checkbox' type='checkbox' "+(form['outsourcing-selection-prenail-dayles']?'checked':'')+"  id='outsourcePrenailDayleid' onclick='outsourcePrenailDayle()'/></label>"
    ...
    outsourcingSelection+= "<input class='checkbox' type='checkbox' "+(form['outsourcing-selection-reinforcing-Wyatt']?'checked':'')+"  /></label>  </li>"
    ...
    outsourcingSelection+= "<input class='checkbox' type='checkbox' "+(form['outsourcing-selection-cladding-jsc']?'checked':'')+"  /></label></li></ul>"
    ...
    outsourcingSelection+= "<input class='checkbox' type='checkbox' "+(form['outsourcing-selection-roofing-roofing-industries-material-only']?'checked':'')+" /></label></li></ul></main></div>"
    ...
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['timber-floor-bearers']?'checked':'')+"  />Bearers"
    ...
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['timber-floor-Joists']?'checked':'')+"  />Joists"
    ...
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['timber-floor-flooring']?'checked':'')+"  />Flooring"
    ...
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['timber-floor-wet-area-flooring']?'checked':'')+"  />Wet Area Flooring"
    ...
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['timber-floor-tile-slate-underlay']?'checked':'')+"  />Tile & Slate Underlay"
    ...
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['wall-framing-prenailer-supplied']?'checked':'')+" />Supplied by Prenailer - Do not allow</label>"
    estimationContent+= "<label class='wall-framing random'for='wall-framing-random'>"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['wall-framing-random']?'checked':'')+"  />Random</label>"
    estimationContent+= "<label class='wall-framing capping'for='wall-framing-capping'>"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['wall-framing-capping']?'checked':'')+"  />Capping</label>"
    estimationContent+= "<label class='wall-framing strapping'for='wall-framing-strapping'>"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['wall-framing-strapping']?'checked':'')+"  />Strapping</label>"
    estimationContent+= "<label class='wall-framing h-one-two'for='wall-framing-h-one-two'>"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['wall-framing-h-one-two']?'checked':'')+"  />H1.2</label>"
    estimationContent+= "<label class='wall-framing h-three-two'for='wall-framing-h-three-two'>"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['wall-framing-h-three-two']?'checked':'')+"  />H3.2</label>"
    estimationContent+= "<label class='wall-framing h-three-plates'for='wall-framing-h-three-plates'>"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['wall-framing-h-three-plates']?'checked':'')+"  />H3 Plates</label>"
    estimationContent+= "<label class='wall-framing beams'for='wall-framing-beams'>"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['wall-framing-beams']?'checked':'')+"  />Beams</label>"
    estimationContent+= "<label class='wall-framing posts'for='wall-framing-posts'>"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['wall-framing-posts']?'checked':'')+"  />Posts</label>"
    estimationContent+= "<label class='wall-framing metal'for='wall-framing-metal'>"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['wall-framing-metal']?'checked':'')+"  />Metal</label>"
    estimationContent+= "<label class='wall-framing timber'for='wall-framing-timber'>"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['wall-framing-timber']?'checked':'')+"  />"
    ...
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['roof-framing-prenailer-supplied']?'checked':'')+"  />"
    ...
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['roof-framing-bor-pack']?'checked':'')+"  />"
    ...
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['roof-framing-ply-membrane']?'checked':'')+"  />"
    ...
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['roof-framing-ply-shingle']?'checked':'')+"  />"
    ...
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['roof-framing-purlins-only']?'checked':'')+"  />"
    ...
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['exterior-finishing-building-wrap']?'checked':'')+"  />"
    ...
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['exterior-finishing-timber-fascia']?'checked':'')+"  />"
    estimationContent+= "Timber Fascia</label>"
    estimationContent+= "<label class='exterior-finishing rab'for='exterior-finishing-rab'>"
    estimationContent+= "RAB<input class='checkbox' type='checkbox' "+(form['exterior-finishing-rab']?'checked':'')+"  />    </label>"
    estimationContent+= "<label class='exterior-finishing metal-fascia'for='exterior-finishing-metal-fascia'>"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['exterior-finishing-metal-fascia']?'checked':'')+"  />"
    ...
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['exterior-finishing-pvc-spouting']?'checked':'')+"  />"
    ...
    estimationContent+= "Soffit<input class='checkbox' type='checkbox' "+(form['exterior-finishing-soffit']?'checked':'')+"  /></label>"
    estimationContent+= "<label class='exterior-finishing eaves-mould'for='exterior-finishing-eaves-mould'>"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['exterior-finishing-eaves-mould']?'checked':'')+"  />"
    ...
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['cladding-brick-check']?'checked':'')+"  />"
    ...
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['cladding-sheet-check']?'checked':'')+"  />"
    ...
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['cladding-w-board-check']?'checked':'')+"  />"
    ...
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['cladding-stone-cladding-substrate']?'checked':'')+"  />"
    ...
    estimationContent+= "<input class='check' type='checkbox' "+(form['insulation-sub-floor-check']?'checked':'')+"  />"
    ...
    estimationContent+= "<input class='check' type='checkbox' "+(form['insulation-mid-floor-check']?'checked':'')+"  />"
    ...
    estimationContent+= "<input class='check' type='checkbox' "+(form['insulation-walls-check']?'checked':'')+"  />"
    ...
    estimationContent+= "<input class='check' type='checkbox' "+(form['insulation-ceiling-check']?'checked':'')+"  />"
    ...
    estimationContent+= "<input class='check' type='checkbox' "+(form['insulation-accoustic-check']?'checked':'')+"  />"
    ...
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['insulation-installation']?'checked':'')+"  />Installation</label></main></div>"
    ...
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['interior-linings-wall']?'checked':'')+"  />Wall</label>"
    estimationContent+= "<label class='interior-linings wet-wall'for='interior-linings-wet-wall'>"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['interior-linings-wet-wall']?'checked':'')+"  />Wet Wall</label>"
    estimationContent+= "<label class='interior-linings bathroom'for='interior-linings-bathroom'>"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['interior-linings-bathroom']?'checked':'')+"  />Bathroom</label>"
    estimationContent+= "<label class='interior-linings wc'for='interior-linings-wc'>"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['interior-linings-wc']?'checked':'')+"  />WC</label>"
    estimationContent+= "<label class='interior-linings ceiling'for='interior-linings-ceiling'>"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['interior-linings-ceiling']?'checked':'')+"  />Ceiling</label>"
    estimationContent+= "<label class='interior-linings wet-ceiling'for='interior-linings-wet-ceiling'>"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['interior-linings-wet-ceiling']?'checked':'')+"  />Wet Ceiling</label>"
    estimationContent+= "<label class='interior-linings ensuite'for='interior-linings-ensuite'>"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['interior-linings-ensuite']?'checked':'')+"  />Ensuite</label>"
    estimationContent+= "<label class='interior-linings laundry'for='interior-linings-laundry'>"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['interior-linings-laundry']?'checked':'')+"  />Laundry</label>"
    estimationContent+= "<label class='interior-linings other'for='interior-linings-other'>"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['interior-linings-other']?'checked':'')+"  />Other</label></main></div>"
    ...
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['interior-doors-door-type']?'checked':'')+"  />MDF HC PQ FJ FLAT JAMB</label>"
    estimationContent+= "<label class='interior-doors door-hardware'for='interior-doors-door-hardware'>"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['interior-doors-door-hardware']?'checked':'')+"  />Door Hardware</label>"
    estimationContent+= "</main>"
    ...
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['interior-finishings-mdf']?'checked':'')+"  /></label>"
    estimationContent+= "<label class='interior-finishings f-j'for='interior-finishings-f-j'>F/J"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['interior-finishings-f-j']?'checked':'')+"  /></label>"
    estimationContent+= "<label class='interior-finishings clears'for='interior-finishings-clears'>Clears"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['interior-finishings-clears']?'checked':'')+"  /></label>"
    estimationContent+= "<label class='interior-finishings timber-cornice'for='interior-finishings-timber-cornice'>Timber Cornice"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['interior-finishings-timber-cornice']?'checked':'')+"  /></label>"
    estimationContent+= "<label class='interior-finishings gib-cove'for='interior-finishings-gib-cove'>Gib Cove"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['interior-finishings-gib-cove']?'checked':'')+"  /></label>"
    estimationContent+= "<label class='interior-finishings skirting'for='interior-finishings-skirting'>Skirting"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['interior-finishings-skirting']?'checked':'')+"  /></label>"
    estimationContent+= "<label class='interior-finishings architrave'for='interior-finishings-architrave'>Architrave"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['interior-finishings-architrave']?'checked':'')+"  /></label>"
    estimationContent+= "<label class='interior-finishings wet-areas'for='interior-finishings-wet-areas'>Wet Areas"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['interior-finishings-wet-areas']?'checked':'')+"  /></label>"
    estimationContent+= "<label class='interior-finishings shelving'for='interior-finishings-shelving'>Shelving"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['interior-finishings-shelving']?'checked':'')+"  /></label>"
    ...
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['landscaping-concrete-patios']?'checked':'')+"  />Concrete Patios</label>"
    estimationContent+= "<label class='landscaping ply-deck'for='landscaping-ply-deck'>"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['landscaping-ply-deck-check']?'checked':'')+"  />Ply Deck"
    ...
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['landscaping-decking']?'checked':'')+"  />Decking</label>"
    estimationContent+= "<label class='landscaping car-port'for='landscaping-car-port'>"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['landscaping-car-port']?'checked':'')+"  />Carport</label>"
    estimationContent+= "<label class='landscaping pergola'for='landscaping-pergola'>"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['landscaping-pergola']?'checked':'')+"  />Pergola</label>"
    estimationContent+= "<label class='landscaping timber-retaining-wall'for='landscaping-timber-retaining-wall'>"
    estimationContent+= "<input class='checkbox' type='checkbox' "+(form['landscaping-timber-retaining-wall']?'checked':'')+"  />Timber Retaining Wall</label>"
    ...
    dayleContentSubmitted+= "<label>Chimney framing<input class='single-input' type='checkbox' "+(form['daylesChimneyFraming']?'checked':'')+" /></label>"
    dayleContentSubmitted+= "<label>LVL Beams<input class='single-input' type='checkbox' "+(form['daylesLVLBeams']?'checked':'')+" /></label>"
    dayleContentSubmitted+= "<label>Glulam Beams<input class='single-input' type='checkbox' "+(form['daylesChimneyFraming']?'checked':'')+" /></label>"
    dayleContentSubmitted+= "<label>Porch Posts<input class='single-input' type='checkbox' "+(form['daylesChimneyFraming']?'checked':'')+" /></label>"
    dayleContentSubmitted+= "<label>Verandah Posts<input class='single-input' type='checkbox' "+(form['daylesChimneyFraming']?'checked':'')+" /></label>"
    dayleContentSubmitted+= "<label>Enclosed balustrades interior<input class='single-input' type='checkbox' "+(form['daylesChimneyFraming']?'checked':'')+"/></label>"
    dayleContentSubmitted+= "<label>Enclosed balustrades exterior<input class='single-input' type='checkbox' "+(form['daylesChimneyFraming']?'checked':'')+"/></label></div>"
